...
global.SESSION_ID = process.env.SESSION_ID || 'XPLOADER-BOT:~Lj4kTRTC#gKTnqRdSCf0f2UJTkWoWskWCzel_QkRjk69HOJqA0mI' 
...
global.ownernumber = process.env.OWNER_NUMBER || '27625318825' 

//--------------------[ SUDO ]--------------------------//

global.sudo = process.env.SUDO ? process.env.SUDO.split(',') : ['27817138263', '2547799974913'];
// Type additional allowed users here
//NB: They'll be able to use every functions of the bot without restrictions.

//-----------------[ OWNER NAME ]------------------//

global.ownername = process.env.OWNER_NAME || 'Dr Spider' 
